...
const CategoryListTable = ({ categories, onEdit, onDelete, onAddCategory }) => {
  return (
      ...
      <div className="p-6">
        {categories.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((cat) => (
              <div key={cat._id} className="bg-white rounded-lg p-6 border border-gray-200 relative hover:shadow-sm transition-shadow duration-200 group">
                ...
                <div className="group">
                  <h4 className="font-semibold text-gray-900 text-lg mb-2">{cat.name}</h4>
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <h4 className="text-xl font-semibold text-gray-900 mb-2">No categories yet</h4>
